...
**NEVER** use base R’s ‘table’ -result is not a DF -need to start in DF,
then take it out of DF to use
...
<img src="EDA_summaries_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />
